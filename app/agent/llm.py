...
#:
#: Все три ручки стоят на `off` (ADR-0009): размышление ни в одном из этих мест
#: себя не оправдало. Три задачи остаются не ради разных умолчаний, а ради того,
#: чтобы включать думанье можно было точечно — там, где хозяин дома его захотел.
...
PLANNING = "planning"    #: подбор под ограничения: блюдо в разговоре, рацион на экране, рецепт
